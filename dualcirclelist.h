...
public:
    ...
    bool set(int i, const T& e)
    {
        ...
        if( ret )
        {
            ...
            list_head* toSet = current->next;
            list_entry(toSet, Node, head)->value = e;
        }
        else
        {
    ...
    bool get(int i, T& e) const
    {
        ...
        if( ret )
        {
            ...
            list_head* toGet = current->next;

            e = list_entry(toGet, Node, head)->value;
        }
        else
        {
            THROW_EXCEPTION(IndexOutOfBoundsException, "Parameter i is invalid...");
